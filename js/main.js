        ...
        $.each(data, function (key, value) {
            if (key == 'about') {
                $.each(value, function (a, v) {
                    aboutHTML += '<div data-aos="fade-zoom-in" data-aos-delay="400" data-aos-duration="1000" class="w-full mb-4">'
                    aboutHTML += '<h2 class="text-primary-foreground text-3xl font-semibold">'
                    aboutHTML += v.title
                    aboutHTML += '</h2>'
                    aboutHTML += '<p class="font-medium text-md mt-3 leading-relaxed text-primary-foreground">' + v.content + '</p>'
                ...
                $.each(value, function (s, v) {
                    ...
                    $.each(v.items, function (as, vs) {
                        ...
                        serviceHTML += '<p class="text-center relative inline-block text-sm text-primary-foreground font-semibold mt-2">' + vs.content + '</p>'
